...
// IsValidCEP provides a mock function with given fields: cep
func (_m *MockZipCodeService) IsValidCEP(cep string) bool {
	ret := _m.Called(cep)
...
//   - cep string
func (_e *MockZipCodeService_Expecter) IsValidCEP(cep interface{}) *MockZipCodeService_IsValidCEP_Call {
	return &MockZipCodeService_IsValidCEP_Call{Call: _e.mock.On("IsValidCEP", cep)}
}

func (_c *MockZipCodeService_IsValidCEP_Call) Run(run func(cep string)) *MockZipCodeService_IsValidCEP_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(string))
	})
	return _c
...
func (_c *MockZipCodeService_IsValidCEP_Call) RunAndReturn(run func(string) bool) *MockZipCodeService_IsValidCEP_Call {
	_c.Call.Return(run)
	return _c
}
